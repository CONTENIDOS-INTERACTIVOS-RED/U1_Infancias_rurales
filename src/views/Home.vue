        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde una mirada histórica y social, la infancia rural en Colombia refleja las tensiones entre las riquezas de los territorios y las inequidades persistentes. Esta unidad invita a explorar cómo las condiciones geográficas, culturales y económicas, influyen en el desarrollo de niños y niñas que crecen en entornos rurales, reconociendo tanto sus desafíos como sus fortalezas. Se abordará la historia de la educación infantil rural, los imaginarios y prácticas de crianza, así como las políticas y contextos que configuran su realidad, para comprender y transformar las condiciones de vida de las infancias en el campo.
              
              p #[b ¡Prepárese para descubrir las voces, realidades y potencialidades, de los niños y las niñas del campo colombiano!]
